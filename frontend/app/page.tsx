...
export default function HomePage() {
  return (
    <AppShell marketing>
      <section className="relative w-full px-3 pb-8 pt-5 sm:px-5 lg:px-6 xl:px-8 2xl:px-10">
        <div className="quay-command-deck quay-terminal-chrome relative overflow-hidden rounded-sm p-4 sm:p-5 lg:p-6 xl:p-7 2xl:p-8">
      ...
      <section className="w-full px-3 pb-6 sm:px-5 lg:px-6 xl:px-8 2xl:px-10">
      ...
      <section id="live-arsenal" className="w-full px-3 pb-12 sm:px-5 lg:px-6 xl:px-8 2xl:px-10">
