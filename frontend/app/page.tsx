...
import { HomeWideRailLeft, HomeWideRailRight } from "@/components/HomeWideRails";
...
export default function HomePage() {
  return (
    <AppShell marketing>
      <section className="relative w-full px-2 pb-8 pt-4 sm:px-3 lg:px-4 xl:px-5">
        <div className="grid w-full grid-cols-1 gap-3 2xl:grid-cols-[minmax(11rem,14rem)_minmax(0,1fr)_minmax(11rem,14rem)] 2xl:gap-4">
          <HomeWideRailLeft />

          <div className="quay-command-deck quay-terminal-chrome relative min-w-0 overflow-hidden rounded-sm p-4 sm:p-5 lg:p-6">
            ...
            <div className="relative grid items-stretch gap-5 xl:grid-cols-12 xl:gap-5">
              <div className="flex flex-col justify-center xl:col-span-4 2xl:col-span-3">
                ...
                <h1 className="mt-5 font-display text-4xl font-bold uppercase leading-[0.92] tracking-wide text-manifest-100 sm:text-5xl xl:text-[3.25rem] 2xl:text-6xl">
                  Watch the quay.
                  <br />
              ...
              <div className="flex min-h-[480px] min-w-0 xl:col-span-3 2xl:col-span-4">
                <HeroSignalRail />
              </div>
            </div>
            ...
            <div className="relative -mx-4 mt-5 sm:-mx-5 lg:-mx-6">
              <ManifestTicker />
            </div>
          </div>
      ...
      <section className="w-full px-2 pb-6 sm:px-3 lg:px-4 xl:px-5">
      ...
      <section className="w-full px-2 pb-12 sm:px-3 lg:px-4 xl:px-5">
