...
const VARIANT: Record<Variant, string> = {
  primary:
    "quay-btn-primary relative overflow-hidden bg-signal-teal text-ink-950 shadow-[0_0_24px_-4px_rgba(45,212,191,0.65)] hover:bg-signal-tealDim hover:shadow-[0_0_36px_-2px_rgba(45,212,191,0.85)] hover:-translate-y-0.5 active:translate-y-0",
  secondary:
